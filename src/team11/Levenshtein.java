...
public final class Levenshtein {
	 ...
	 *            The domain of query.
	 * @param count
	 *            Counting the appear times of each query.
	 *  
	 * @return An arraylist of cleaned query list.
	 * @throws FileNotFoundException  If an open or output 
	 *                      		  exception occurred
	 ...
	 * @see me.xdrop.fuzzywuzzy
	 */
	public static ArrayList<String> handleStringArrayList2(ArrayList<String> uid, ArrayList<String> data,
			ArrayList<String> time, ArrayList<String> domain, ArrayList<Integer> count) throws FileNotFoundException {
...
//				System.out.println("A string: " + sortedNow + ", B string: " + sortedNext);
	...
	public static void main(String[] args) throws IOException {
		...
		CsvReader reader = new CsvReader(
				"/Users/Tim/Desktop/research paper/CapstoneCourseSpring2017/data/finaldatasetpart2(cleanedSam).csv");
		...
		//data = Levenshtein.handleStringArrayList(uid, data, timestamp, domain); // keep all longest queries
		data = Levenshtein.handleStringArrayList2(uid, data, timestamp, domain, count); //keep only one longest query

		CsvWriter writer = new CsvWriter(
				"/Users/Tim/Desktop/research paper/CapstoneCourseSpring2017/data/finaldatasetpart2(Tim)_onlyone.csv");
		writer.writeRecord(header);
		for (int i = 0; i < data.size(); i++) {
			String[] tmp = { uid.get(i), data.get(i), domain.get(i), timestamp.get(i), count.get(i).toString() };
