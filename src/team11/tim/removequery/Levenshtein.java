 ...
 */
     ...
     *      ArrayList<String> arrayString
     */
        public static ArrayList<String> handleStringArrayList2(ArrayList<String> data, ArrayList<String> time, ArrayList<String> domain) throws FileNotFoundException {
            ...
            while(i < originalData.size() - 1) {
                ...
                if ((rate > 85 || fuzzRate > 85) && fuzzRate != 100) {
    ...
    public static void main(String[] args) throws IOException {
		...
		CsvReader reader = new CsvReader("/Users/Tim/Desktop/research paper/CapstoneCourseSpring2017/data/finaldatasetpart1(cleanedSam).csv");
		...
		data = Levenshtein.handleStringArrayList2(data, timestamp, domain);
		
		CsvWriter writer = new CsvWriter("/Users/Tim/Desktop/research paper/CapstoneCourseSpring2017/data/finaldatasetpart1(Tim).csv");
		writer.writeRecord(header);
		for(int i = 0; i < data.size(); i ++) {
			String[] tmp = {"", data.get(i), domain.get(i), timestamp.get(i)};
